  ...
  <div class="relative <?php echo $section_padding_top . ' ' . $section_padding_bottom ?>">
    <div class="container max-w-screen-xl relative">
      <div class="flex flex-col lg:flex-row lg:gap-x-12 lg:items-end">
        <div class="w-full lg:w-2/3">
          ...
          <?php endif; ?>
          <?php if ($headline) : ?>
            <h3 class="text-[34px] leading-tight font-bold text-brand-red mt-12 mb-6"><?php echo $headline; ?></h3>
          <?php endif; ?>
          <?php if ($description) : ?>
            <div class="prose">
        ...
        <div class="w-full lg:w-1/3 flex flex-col items-end">
          <?php if ($show_search) : ?>
            <div class="flex p-1 w-full border border-slate-200 shadow-[inset_0px_2px_6px_0px_rgba(0,0,0,0.12)] rounded-full overflow-hidden mt-8 lg:mt-0">
              <input id="knowledge_box-search" type="text" placeholder="Insert your query" name="knowledge_box-search" class="input h-10 lg:h-12 text-sm lg:text-base px-4 lg:px-6 w-full bg-transparent focus:outline-0 focus:border-0 focus:ring-0">
              <button id="knowledge_box-search-button" class="rounded-full px-6 lg:px-10 bg-brand-gray font-bold text-white">Search</button>
            </div>
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="container max-w-screen-xl">
      <div class="px-12 lg:px-14 relative -mx-2 lg:-mx-0">
        <div id="knowledge_box-filter" class="swiper mt-6 lg:mt-10 px-2 pt-2 pb-4">
          <div class="swiper-wrapper filter-knowledge_box-buttons">
            <?php
        ...
        <button type="button" class="knowledge_box-filter--button-prev left-0">
        ...
        <button type="button" class="knowledge_box-filter--button-next right-0">
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <script>
        const knowledge_box_filter = new Swiper('#knowledge_box-filter', {
          slidesPerView: 'auto',
          spaceBetween: 12,
          loop: false,
          watchOverflow: true,
          ...
          navigation: {
            nextEl: '.knowledge_box-filter--button-next',
            prevEl: '.knowledge_box-filter--button-prev',
          },
          breakpoints: {
            768: {
              slidesPerView: 'auto',
    ...
    if ($the_query->have_posts()) { ?>
      <div class="container max-w-screen-xl">
        <div class="knowledge_box-loader pt-2 pb-4">
          <div class="flex items-center justify-center">
            <svg class="spinning-loader animate-spin h-8 w-8 text-brand-red opacity-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
          </div>
        </div>
        <div class="knowledge_box-grid relative">
            ...
            ?>
              <div>
                ...
                <div class="mt-6">
                  ...
                  <div class="mt-8">
                    <a href="<?php echo $link ?>" class="btn btn-red"><span>Read More</span></a>
                  </div>
                </div>
              </div>
            <?php } ?>
