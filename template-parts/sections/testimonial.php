    ...
    <div class="py-6 lg:py-0">
      <?php if ($headline) : ?>
        <div class="container max-w-screen-md">
          <h3 class="text-3xl lg:text-[34px] leading-tight font-bold text-brand-red text-center mt-6 mb-6"><?php echo $headline ?></h3>
        </div>
      <?php endif; ?>
            ...
            <?php foreach ($testimonial_posts as $slide) : ?>
              ...
              <div class="swiper-slide">
                <div class="container max-w-screen-lg text-center text-black">
                  <?php if ($testimonial) : ?>
                    <div class="font-nunito text-base md:text-lg"><?php echo $testimonial ?></div>
                  <?php endif; ?>
